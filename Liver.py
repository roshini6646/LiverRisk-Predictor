...
# Reading Dataset:
dataset = pd.read_csv("C://Users//chelimela roshini//Downloads//Liver-Disease-Prediction-Project-main-main//Liver-Disease-Prediction-Project-main-main//Dataset//Liver_data.csv")
